...
export default function AssignmentsPage({
  ...
  const rows = useMemo(() => {
    if (allItems.length > 0) {
      return allItems.slice(0, 5).map(item => ({
        ...
        detail: [item.grade, item.subject, item.topic, item.skill].filter(Boolean).join(' / ') || 'assignments',
  ...
  return (
    <section className={styles.section}>
      <div className={styles.sectionHeader}>
        ...
        <div className={styles.headerActions}>
          <button type="button" onClick={onOpenForm} className={styles.addBtn}>
            ...
            {moduleConfig.primaryAction || 'Tạo bài tập'}
          </button>
      ...
      {/* Assignments Stitch Preview Table Layout */}
      ...
      <div className={styles.modulePanel}>
        <div className={styles.modulePanelHeader}>
          <div>
            <h3>Assignments Records</h3>
            <p>CRUD dữ liệu CMS thật trong DB, lưu trữ các bài tập được giao theo lớp/kỹ năng</p>
          </div>
          <div className={styles.moduleActions}>
            <button type="button" onClick={onOpenForm} className={styles.addBtn}>
              <MaterialIcon>add</MaterialIcon>
              {moduleConfig.primaryAction || 'Giao bài tập'}
            </button>
        ...
        <div className={styles.cmsToolbar}>
          <div className={styles.searchBox}>
            ...
            <input
              type="text"
              placeholder="Tìm trong Assignments..."
              value={search}
        ...
        <div className={styles.moduleTable}>
          {loading ? (
            <div className={styles.loader}><div className={styles.spinner} /> Đang tải Assignments...</div>
            ...
            <div className={styles.cmsEmpty}>
              <span>
                <MaterialIcon filled>assignment</MaterialIcon>
              </span>
              <strong>Chưa giao bài tập nào</strong>
              <p>Giao bài đầu tiên để học sinh thực hành theo kế hoạch.</p>
              <button type="button" onClick={onOpenForm} className={styles.addBtn}>
                <MaterialIcon>add</MaterialIcon>
                {moduleConfig.primaryAction || 'Giao bài tập'}
              </button>
