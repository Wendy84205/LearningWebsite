      ...
      <header className={styles.topBar}>
        <div className={styles.greeting}>
          <span className={styles.greetingText}>
            ...
            <MaterialIcon style={{ verticalAlign: 'middle', marginLeft: '6px', color: '#ffb953' }}>waving_hand</MaterialIcon>
          </span>
        </div>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.mascotArea} onClick={handleMascotSpeech} style={{ cursor: 'pointer' }}>
          <div className={styles.mascotBubble}>
            <span className={styles.speechText}>
              ...
              <MaterialIcon filled style={{ verticalAlign: 'middle', marginLeft: '6px', color: '#ffb953' }}>star</MaterialIcon>
            </span>
          </div>
        ...
        <div className={styles.mainActions}>
          <Link href="/nursery-map" id="btn-learning-map" className={styles.actionCard}>
            <MaterialIcon className={styles.actionIcon} style={{ color: 'var(--primary)' }}>map</MaterialIcon>
            ...
            <MaterialIcon className={styles.actionArrow}>arrow_forward</MaterialIcon>
          </Link>

          <Link href="/kids-closet" id="btn-closet" className={styles.actionCard}>
            <MaterialIcon className={styles.actionIcon} style={{ color: 'var(--secondary)' }}>styler</MaterialIcon>
            <div className={styles.actionInfo}>
        ...
        <div className={styles.miniStats}>
          <div className={styles.miniStat}>
            <MaterialIcon className={styles.miniStatIcon} style={{ color: 'var(--primary)' }}>menu_book</MaterialIcon>
            <div className={styles.miniStatVal}>{progress.currentLevel}</div>
            <div className={styles.miniStatLabel}>Cấp hiện tại</div>
          </div>
          <div className={styles.miniStat}>
            <MaterialIcon className={styles.miniStatIcon} style={{ color: '#10b981' }}>check_circle</MaterialIcon>
            <div className={styles.miniStatVal}>{completedCount}</div>
            <div className={styles.miniStatLabel}>Đã xong</div>
          </div>
          <div className={styles.miniStat}>
            <MaterialIcon filled className={styles.miniStatIcon} style={{ color: '#ffb953' }}>star</MaterialIcon>
            <div className={styles.miniStatVal}>{progress.stars}</div>
            <div className={styles.miniStatLabel}>Tổng số sao</div>
          </div>
          <div className={styles.miniStat}>
            <MaterialIcon filled className={styles.miniStatIcon} style={{ color: '#ff6f00' }}>local_fire_department</MaterialIcon>
        ...
        <div className={styles.quickStart}>
          <h2 className={styles.quickStartTitle}>
            Luyện tập nhanh
            <MaterialIcon style={{ verticalAlign: 'middle', marginLeft: '8px', color: 'var(--primary)' }}>rocket_launch</MaterialIcon>
          </h2>
          <div className={styles.quickGrid}>
            <Link href={quickPractices.math.href} id="btn-game-1" className={styles.quickCard}>
              <MaterialIcon className={styles.quickIcon} style={{ color: 'var(--primary)' }}>calculate</MaterialIcon>
            ...
            <Link href={quickPractices.vietnamese.href} id="btn-game-2" className={styles.quickCard}>
              <MaterialIcon className={styles.quickIcon} style={{ color: '#10b981' }}>menu_book</MaterialIcon>
            ...
            <Link href={quickPractices.matching.href} id="btn-game-3" className={styles.quickCard}>
              <MaterialIcon className={styles.quickIcon} style={{ color: 'var(--secondary)' }}>extension</MaterialIcon>
